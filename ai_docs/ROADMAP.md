...
- [ ] **[TASK-P2-01]** 브랜드 목록 페이지 Notion 실데이터 연동
...
- [ ] **[TASK-P2-02]** 브랜드별 캡슐 목록 페이지 Notion 실데이터 연동
...
- [ ] **[TASK-P2-03]** 캡슐 상세 페이지 Notion 실데이터 연동
...
- [ ] **[TASK-P2-04]** 홈 페이지 `BrandShowcase` 컴포넌트 실데이터 연동
...
### Phase 3: 핵심 기능 — 사용자 참여 (CRUD + 스팸 방지)
...
- [ ] **[TASK-P3-04]** 커뮤니티 게시글 목록 페이지 Supabase 연동 (GET)
...
- [ ] **[TASK-P3-05]** 게시글 작성 API 라우트 실데이터 연동 검증 (POST)
...
- [ ] **[TASK-P3-07]** 게시글 상세 페이지 Supabase 연동 (GET)
...
- [ ] **[TASK-P3-08]** 댓글 작성 API 라우트 실데이터 연동 검증 (POST)
...
- [ ] **[TASK-P3-10]** 서버사이드 Turnstile 검증 로직 E2E 확인
...
- [ ] **[TASK-P3-11]** 게시글 조회수(`view_count`) 증가 로직 구현
...
- [ ] **[TASK-P4-01]** 브랜드별 캡슐 목록 페이지에 `CapsuleSearch` + `IntensityFilter` 연동
  - 파일: `frontend/app/(main)/brands/[brandSlug]/page.tsx`
  - 예상 시간: 1.5h
  - 의존성: TASK-P2-02
  - 작업 내용:
...
- [ ] **[TASK-P4-02]** 커뮤니티 카테고리 탭 필터링 React Query 또는 서버 액션으로 교체
  - 파일: `frontend/app/(main)/community/page.tsx`
  - 예상 시간: 1.5h
  - 의존성: TASK-P3-04
...
- [ ] **[TASK-P4-03]** 빈 상태(empty state) UI 전체 점검 및 구현
...
- [ ] **[TASK-P4-04]** 에러 상태 처리 및 `error.tsx` 완성
